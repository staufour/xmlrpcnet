...
<name>price</name>
            ...
            XmlRpcSerializer serializer = new XmlRpcSerializer();
            serializer.NonStandard = XmlRpcNonStandard.IgnoreDuplicateMembers;
            Assert.That(() => serializer.DeserializeResponse(sr1, typeof(XmlRpcStruct)),
...
<name>price</name>
            ...
            XmlRpcSerializer serializer = new XmlRpcSerializer();
            serializer.NonStandard = XmlRpcNonStandard.IgnoreDuplicateMembers;
            Assert.That(() => serializer.DeserializeResponse(sr1, typeof(Donhrobjartz)),
                Throws.TypeOf<XmlRpcInvalidXmlRpcException>());
        }
...
<value><string>284</string></value>
            ...
            XmlRpcSerializer serializer = new XmlRpcSerializer();
            serializer.NonStandard = XmlRpcNonStandard.IgnoreDuplicateMembers;
            Assert.That(() => serializer.DeserializeResponse(sr1, typeof(Donhrobjartz)), Throws.TypeOf<XmlRpcInvalidXmlRpcException>());
        }
