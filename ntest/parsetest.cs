...
namespace ntest
{
    ...
    public class ParseTest
    {
        ...
        public void Int_TooLarge()
        {
            ...
            Assert.That(() => Utils.Parse(xml, typeof(int), MappingAction.Error, out parsedType, out parsedArrayType),
      ...
      <value><i4>14</i4></value>
        ...
        public void XmlRpcInt_XmlRpcIntType()
        {
            ...
            object obj = Utils.Parse(xml, typeof(XmlRpcInt), MappingAction.Error,
              out parsedType, out parsedArrayType);
            Assert.That(obj, Is.InstanceOf<XmlRpcInt>());
            Assert.AreEqual(new XmlRpcInt(12345), (XmlRpcInt)obj);
        }
    ...
    <member>
      ...
      <value><i4>2</i4></value>
            ...
            object obj = Utils.Parse(xml, typeof(XmlRpcStruct), MappingAction.Error,
              out parsedType, out parsedArrayType);
            Assert.That(obj, Is.InstanceOf<XmlRpcStruct>());
